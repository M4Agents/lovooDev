...
export const Settings: React.FC = () => {
  ...
  const { canManageOpenAI, isSaaSAdmin, isSystemAdmin, canManageConversationalAgents, canManageAiGovernance, canAccessCompanies, canAccessPlans, canPurchaseAiCredits, canManageNotifications, canPurchaseConsulting, canManageConsultingCatalog, canLogConsultingHours, canViewImportHistory } = useAccessControl();
