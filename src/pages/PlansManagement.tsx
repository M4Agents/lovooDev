    ...
    try {
      ...
      if (editingPlan) {
        const { data, error: rpcError } = await supabase.rpc('update_plan', {
          ...
          p_max_funnels:                            toInt(formData.max_funnels),
          p_max_funnel_stages:                      toInt(formData.max_funnel_stages),
          p_max_automation_flows:                   toInt(formData.max_automation_flows),
          p_max_automation_executions_monthly:      toInt(formData.max_automation_executions_monthly),
          p_max_products:                           toInt(formData.max_products),
          p_storage_mb:                             toInt(formData.storage_mb),
