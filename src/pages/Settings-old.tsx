...
export const Settings: React.FC = () => {
  ...
  // Estados para abas e dados da empresa (removido - movido para Companies)
...
{`{
  ...
  "behavior_analytics": {
    ...
    "time_to_convert": 180
      ...
      {/* Aba Contatos - Apenas para empresas filhas */}
      {isChildCompany && activeTab === 'contatos' && (
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
          <div className="flex items-center gap-3 mb-6">
            <div className="p-2 bg-green-100 rounded-lg">
      ...
      {/* Aba Domínios & URLs - Apenas para empresas filhas */}
      {isChildCompany && activeTab === 'dominios' && (
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
          <div className="flex items-center gap-3 mb-6">
            <div className="p-2 bg-purple-100 rounded-lg">
