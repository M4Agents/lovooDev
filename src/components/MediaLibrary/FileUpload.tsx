...
export const FileUpload: React.FC<FileUploadProps> = ({
  ...
  const uploadFile = async (uploadFile: UploadFile): Promise<void> => {
    try {
      ...
      // ============================================================
      // CÓDIGO NOVO - 2026-02-22 11:45 - UPLOAD DIRETO S3
      // ============================================================
      console.log('🚀🚀🚀 CÓDIGO NOVO EXECUTANDO - 2026-02-22 11:45 🚀🚀🚀')
      console.log('✅ SEMPRE usa mediaManagement.uploadFile()')
      console.log('✅ Arquivos < 4MB: API normal')
      console.log('✅ Arquivos > 4MB: S3Storage direto (sem Vercel)')
      console.log('🔍 DEBUG - selectedFolderId:', selectedFolderId)
      console.log('🔍 DEBUG - companyId:', companyId)
      console.log('🔍 DEBUG - arquivo:', uploadFile.file.name)
      console.log('🔍 DEBUG - tamanho:', uploadFile.file.size, 'bytes')
      
      const uploadData: FileUploadData = {
        file: uploadFile.file,
        folder_id: selectedFolderId || currentFolderId,
        tags: undefined
      }
