-- MIGRATION: Adicionar reentry_count ao JSON retornado por get_funnel_positions_with_photos
-- reentry_count = número de eventos lead_reentry em opportunity_stage_history por oportunidade
-- Usado para exibir badge "Reengajado (N)" no card do kanban sem N+1 queries
...
BEGIN
  ...
  FROM (
    ...
    -- Contagem de reentradas por oportunidade (sem N+1)
    LEFT JOIN (
