...
-- Migration 2/2: RPC get_snapshot_health_score
--
-- Computa o health score consolidado de um tenant para uma data.
-- Retorna JSONB com score final (0–100), severidade e componentes.
--
-- Fórmula:
--   health_score = (
...
--
-- Severidade:
--   85–100 → healthy  (verde)
--   65–84  → degraded (amarelo)
--   40–64  → warning  (laranja)
--   0–39   → critical (vermelho)
--
-- Não persiste — calculado on-demand.
-- Usado por: GET /api/dashboard/snapshot-health
-- =====================================================
...
BEGIN
  ...
  -- ── 7. BLOCKER (o componente mais fraco que impede FASE 4.2) ─────────────
