-- =====================================================
-- MIGRATION: update get_funnel_positions_with_photos
-- Data: 02/04/2026
-- Objetivo: Adiciona filtros server-side (busca, origem,
--           período) à RPC e substitui REGEXP_REPLACE inline
--           pelo campo gerado phone_normalized para tornar
--           os JOINs sargables.
--
-- DEPENDÊNCIAS: migration 20260402130000 (phone_normalized)
--               deve estar aplicada antes deste script.
--
-- Parâmetros novos:
