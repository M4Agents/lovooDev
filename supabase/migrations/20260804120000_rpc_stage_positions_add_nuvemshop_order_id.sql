-- Adiciona nuvemshop_order_id ao objeto opportunity retornado pela RPC get_stage_positions_paged.
-- Sem este campo, o OpportunityDetailModal aberto pelo FunnelBoard não consegue avaliar
-- hasNuvemshopOrder = !!opportunity.nuvemshop_order_id e a aba Nuvemshop fica oculta,
-- pois o stageMap (carregado pela RPC) tem precedência sobre o getOpportunityById (select *).
