-- Migration: Adiciona coluna utm_medium à tabela leads e atualiza RPC de webhook
-- para salvar todos os campos de marketing/UTM: campanha, conjunto_anuncio, anuncio, utm_medium

-- 1. Nova coluna utm_medium (as demais já existem: campanha, conjunto_anuncio, anuncio)
ALTER TABLE public.leads
  ADD COLUMN IF NOT EXISTS utm_medium CHARACTER VARYING;

-- 2. Atualizar RPC public_create_lead_webhook para aceitar e salvar os campos UTM
