-- =====================================================================
-- ESTADO ATUAL: RPCs de Dashboard ANTES das migrations
--
-- Fontes:
--   get_dashboard_funnel_executive → 20260511140000_fix_dashboard_rpcs_column_refs.sql
--                                    (última versão: usa is_hidden = false)
...
--
-- M6c altera estas RPCs adicionando guard de acesso:
--   IF auth.uid() IS NOT NULL AND NOT auth_user_can_access_funnel(...) THEN RAISE
-- =====================================================================

-- ══════════════════════════════════════════════════════════════════════
-- 1. get_dashboard_funnel_executive
--    Estado atual (20260511140000 — usa is_hidden = false)
-- ══════════════════════════════════════════════════════════════════════
...
--    Estado atual (20260609180000 — com deduplicação)
-- ══════════════════════════════════════════════════════════════════════
