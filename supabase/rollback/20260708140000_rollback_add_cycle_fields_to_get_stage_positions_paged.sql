-- =====================================================
-- ROLLBACK: 20260708140000_add_cycle_fields_to_get_stage_positions_paged
-- Data: 08/07/2026
-- Objetivo: Reverter para o estado da migration 20260625160000,
--           removendo os 7 campos de ciclo de contato do retorno
--           e restaurando o corpo original da função.
--
-- Estratégia: CREATE OR REPLACE FUNCTION (sem DROP)
--   A assinatura não muda (14 parâmetros idênticos).
--   Apenas o corpo interno é restaurado.
--
-- Fonte da versão restaurada:
--   supabase/migrations/20260625160000_fix_owner_filter_use_responsible_user_id.sql
-- =====================================================
