...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log('🔍 Fields completos:', JSON.stringify(fields, null, 2))
    ...
    console.log('⚠️ folder_id é null?', folder_id === null)
    console.log('⚠️ folder_id é undefined?', folder_id === undefined)
