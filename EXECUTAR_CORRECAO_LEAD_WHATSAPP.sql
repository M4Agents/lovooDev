-- =====================================================
-- CORREÇÃO URGENTE: Função create_lead_from_whatsapp_safe
-- Data: 25/03/2026
-- Problema: Novos leads do WhatsApp não estão sendo cadastrados
-- Erro: relation "lead_funnel_positions" does not exist
-- Solução: Atualizar função para criar lead + opportunity e usar tabela correta
-- =====================================================
-- 
-- INSTRUÇÕES:
...
-- 5. Teste enviando mensagem via WhatsApp
-- =====================================================
...
-- VERIFICAÇÃO
-- =====================================================
-- Após executar, verifique se a função foi atualizada:
-- SELECT routine_name, routine_definition 
-- FROM information_schema.routines 
-- WHERE routine_name = 'create_lead_from_whatsapp_safe';
